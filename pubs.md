...
**Real-time RGBD-based Extended Body Pose Estimation**   [bib]({{site.url}}/scripts/publications/bib/bashirov2021real.bib) 
 ...
 Bashirov, Renat and Ianina, Anastasia and Iskakov, Karim and Kononenko, Yevgeniy and Strizhkova, Valeriya and Lempitsky, Victor and Vakhitov, Alexander
...
**Relative Localization for Aerial Manipulation with PL-SLAM**   [bib]({{site.url}}/scripts/publications/bib/pumarola2019relative.bib) 
 ...
 Pumarola, Albert and Vakhitov, Alexander and Agudo, Antonio and Moreno-Noguer, Francesc and Sanfeliu, Alberto

  Aerial Robotic Manipulation, 2019,  pp. 239--248 


**Textured Neural Avatars**   [bib]({{site.url}}/scripts/publications/bib/shysheya2019textured.bib) 

 Shysheya, Aliaksandra and Zakharov, Egor and Aliev, Kara-Ali and Bashirov, Renat and Burkov, Egor and Iskakov, Karim and Ivakhnenko, Aleksei and Malkov, Yury and Pasechnik, Igor and Ulyanov, Dmitry and Vakhitov, Alexander and Lempitsky, Victor

  Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition (CVPR), 2019,  pp. 2387--2397 


**Coordinate-based Texture Inpainting for Pose-Guided Image Generation**   [bib]({{site.url}}/scripts/publications/bib/grigorev2018coordinate.bib) 

 Grigorev, Artur and Sevastopolsky, Artem and Vakhitov, Alexander and Lempitsky, Victor

  Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition (CVPR), 2019,  pp. 12135--12144 


**Learnable Line Segment Descriptor for Visual SLAM**  [pdf]({{site.url}}/scripts/publications/files/vakhitov-lld-2019.pdf)  [bib]({{site.url}}/scripts/publications/bib/vakhitov2019learnable.bib) 
...
**CarpetVR: The Magic Carpet Meets the Magic Mirror**   [bib]({{site.url}}/scripts/publications/bib/lempitsky2018carpetvr.bib) 
 ...
 Lempitsky, Victor and Vakhitov, Alexander and Starostin, Andrew
  ...
  Proceedings of the IEEE Conference on Virtual Reality and 3D User Interfaces (VR), 2018,  pp. 1--1 
...
**Accurate and linear time pose estimation from points and lines**  [pdf]({{site.url}}/scripts/publications/files/pnpl2016.pdf)  [bib]({{site.url}}/scripts/publications/bib/vakhitov2016accurate.bib) 

 Vakhitov, Alexander and Funke, Jan and Moreno-Noguer, Francesc

  Proceedings of the European Conference on Computer Vision, 2016,  pp. 583--599 


**Estimating the position of a moving object based on test disturbance of camera position**  [pdf]({{site.url}}/scripts/publications/files/krivokon2016.pdf)  [bib]({{site.url}}/scripts/publications/bib/krivokon2016estimating.bib) 

 Krivokon, Dmitry S and Vakhitov, Alexander T and Granichin, Oleg N

  Automation and Remote Control, 2016,  pp. 297--312 


#### 2015

**Camera Pose and Focal Length Estimation Using Regularized Distance Constraints**  [pdf]({{site.url}}/scripts/publications/files/kanaeva2015.pdf)  [bib]({{site.url}}/scripts/publications/bib/kanaeva2015camera.bib) 

 Kanaeva, Ekaterina and Gurevich, Lev and Vakhitov, Alexander
...
**Finite difference and simultaneous perturbation stochastic approximation with fixed step sizes in case of multiplicative noises**  [pdf]({{site.url}}/scripts/publications/files/vakhitov2014.pdf)  [bib]({{site.url}}/scripts/publications/bib/vakhitov2014finite.bib) 

 Vakhitov, Alexander

  2014 European Control Conference (ECC), 2014,  pp. 1613--1618 


**Randomized algorithm for estimation of moving point position using single camera**  [pdf]({{site.url}}/scripts/publications/files/krivokon-cdc-2014.pdf)  [bib]({{site.url}}/scripts/publications/bib/krivokon2014randomized.bib) 

 Krivokon, Dmitry and Vakhitov, Alexander

  Conference on Decision and Control, 2014,  pp. 5189--5194 


#### 2012

**Randomized smoothing for near-convex functions in context of image processing**  [pdf]({{site.url}}/scripts/publications/files/vakhitov-acc-2012.pdf)  [bib]({{site.url}}/scripts/publications/bib/minin2012randomized.bib) 

 Minin, Ivan and Vakhitov, Alexander

  American Control Conference (ACC), 2012,  pp. 833--838 


#### 2011

**Non-stationary optimization with prediction step for object tracking with two cameras**   [bib]({{site.url}}/scripts/publications/bib/krivokon2011non.bib) 

 Krivokon, D. and Vakhitov, A.

  International Student Olympiad on Automatic Control Control (Baltic Olympiad), 2011  


**General method for network providers to choose applications with guaranteed QoS**  [pdf]({{site.url}}/scripts/publications/files/pansh-bell-2011.pdf)  [bib]({{site.url}}/scripts/publications/bib/panshenskov2011general.bib) 

 Panshenskov, Mikhail and Vakhitov, Alexander

  Bell Labs Technical Journal, 2011,  pp. 57--61 


#### 2010

**Adaptive control of SISO plant with time-varying coefficients based on random test perturbation**  [pdf]({{site.url}}/scripts/publications/files/siso2010.pdf)  [bib]({{site.url}}/scripts/publications/bib/vakhitov2010adaptive.bib) 

 Vakhitov, Alexander and Vlasov, Vsevolod and Granichin, Oleg

  Proceedings of the American Control Conference, 2010,  pp. 4004--4009 
...
**Transfer Speed Estimation for Adaptive Scheduling in the Data Grid**   [bib]({{site.url}}/scripts/publications/bib/panshenskov2009transfer.bib) 
 ...
 Panshenskov, Mikhail and Vakhitov, Alexander
  ...
  Workshop at the Grid and Pervasive Computing Conference, 2009,  pp. 58--63 


**Methods of linear transfer speed estimation in the data grid**   [bib]({{site.url}}/scripts/publications/bib/vakhitov2009methods.bib) 

 Vakhitov, Alexander and Panshenskov, Mikhail

  Proceedings of the 1st ACM workshop on Data grids for eScience, 2009,  pp. 29--34 


**SPSA with a fixed gain for intelligent control in tracking applications**  [pdf]({{site.url}}/scripts/publications/files/vakhitov-intcontr-2009.pdf)  [bib]({{site.url}}/scripts/publications/bib/granichin2009spsa.bib) 

 Granichin, Oleg and Gurevich, Lev and Vakhitov, Alexander

  Confeence on Control Applications (CCA), 2009,  pp. 1415--1420 


**Minimum tracking with SPSA and applications to image registration**  [pdf]({{site.url}}/scripts/publications/files/vakhitov-imagereg-2009.pdf)  [bib]({{site.url}}/scripts/publications/bib/granichin2009minimum.bib) 
...
**Discrete-time minimum tracking based on stochastic approximation algorithm with randomized differences**  [pdf]({{site.url}}/scripts/publications/files/cdc2009.pdf)  [bib]({{site.url}}/scripts/publications/bib/granichin2009discrete.bib) 
 ...
 Granichin, Oleg and Gurevich, Lev and Vakhitov, Alexander
  ...
  Conference on Decision and Control, 2009,  pp. 5763--5767 


#### 2008

**SPSA Algorithm for tracking**   [bib]({{site.url}}/scripts/publications/bib/gurevich2008spsa.bib) 

 Gurevich, L and Vakhitov, A

  Proc. 12th International Student Olympiad on Automatic Control (Baltic Olympiad), 2008,  pp. 52--57 
...
**SPSA-based adaptive control: accuracy of estimates**  [pdf]({{site.url}}/scripts/publications/files/vakhitov2007spsa.pdf)  [bib]({{site.url}}/scripts/publications/bib/vakhitov2007spsa.bib) 
 ...
 Vakhitov, Alexander T and Granichin, Oleg N

  IFAC Proceedings Volumes, 2007,  pp. 429--434 
